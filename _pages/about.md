...
In the undergraduate admission test (2018), I had the opportunity to choose CSE at SUST (700th merit position). However, I lacked prior experience in programming at the time compared to the other admitted peers and doubted my ability to be the topper in CSE. Therefore, I carefully chose Industrial & Production Engineering (IPE) instead. From my first year (2018), I began learning C/C++ and Python for problem-solving while maintaining academic excellence. I participated in international Mathematics (2019) and Astrophysics (2020) Olympiads at the undergraduate level, tackling complex research problems. My first taste of success on the international stage came from solving these research questions using my own algorithms, which significantly boosted my confidence and solidified my decision to switch and pursue a research career in AI. Since then, I have never stopped or looked back. I continuously invested in lifelong learning, spending about 40% of my first hard-earned internship salary on online courses offered by top-tier schools. I deeply believe in the loyalty of knowledge and its enduring value.
