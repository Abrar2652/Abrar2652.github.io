...
I am an incoming **CS PhD student** at the [Thomas Lord Department of Computer Science, Viterbi School of Engineering](https://www.cs.usc.edu/){:target="_blank"}, **[University of Southern California (USC)](https://www.usc.edu/){:target="_blank"}**. I am affiliated with the *[Center on Knowledge Graphs](https://www.isi.edu/centers-ckg/){:target="_blank"}* at the **[Information Sciences Institute (ISI)](https://www.isi.edu/){:target="_blank"}**, located at the heart of Silicon Beach. I am fortunate to be co-advised by **[Prof. Craig Knoblock](https://www.isi.edu/people-knoblock/){:target="_blank"}** and **[Prof. Jay Pujara](https://www.isi.edu/directory/jpujara/){:target="_blank"}**. My research at ISI will be generously supported by the **Defense Advanced Research Projects Agency (DARPA)**, a US Department of Defense agency. I have also been awarded the **USC Graduate Fellowship**.
