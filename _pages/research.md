...
| ■ Enhanced efficiency by optimizing Nash and Lenhard's 3 R scripts for PCS generation, quantile kurtosis analysis, and genomic regulatory blocks (GRBs), reducing time and memory complexity. Successfully reproduced PCS coordinates following UCSC format | 
...
| _Supervisors:_ [Ghada Bouzidi](https://www.linkedin.com/in/ghada-bouzidi-12236a58/?originalSubdomain=no){:target="_blank"}, [Professor Aleksander Pedersen](https://en.uit.no/ansatte/person?p_document_id=445080){:target="_blank"}, [Professor Rune Dalmo](https://en.uit.no/ansatte/rune.dalmo){:target="_blank"} |  
| _Duties included:_   |  |
...
| ■ Designed, implemented, and evaluated machine learning models (Classifiers: K-Neighbors, Logistic Regression, XGBClassifier, Prophet) that identified the road state as one of the following states: Dry, Moist, Wet, Icy, Snowy, Slushy) to tackle the winter weather challenges encountered in the Barren Euro-Arctic region |
| ■ Introduced a new safety metric and forecasted its values using machine learning regressors: Ridge, Lasso, Elastic Net, Linear Regression, XGBRegressor |
...
Performed a total of 8 journal reviews verified by Web of Science, as of Aug 2024 ([Web of Science ResearcherID: AFE-0313-2022](https://www.webofscience.com/wos/author/record/AFE-0313-2022)).
* IEEE Access
